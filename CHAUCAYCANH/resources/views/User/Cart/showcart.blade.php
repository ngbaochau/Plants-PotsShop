            ...
            <div class="col-sm-6">
                <div class="total_area">
                    <ul>
                        ...
                        {{-- <a class="btn btn-default update" href="">Sửa</a> --}}
                                <?php
									$customer_id =  Session::get('CusID');
								
									if($customer_id !== null){
								?>
									<a class="btn btn-default check_out" href="{{ URL::to('/checkout')}}">MUA HÀNG</a>
								<?php 
									} else {
								?>
									<a class="btn btn-default check_out" href="{{ URL::to('/login_checkout')}}">MUA HÀNG</a>
								<?php
									}
								?>
