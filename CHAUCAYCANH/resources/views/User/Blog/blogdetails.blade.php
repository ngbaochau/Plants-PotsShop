			...
			<div class="row">
				<div class="col-sm-12">
					<div class="blog-post-area">
						...
						@if(is_object($detailsblog))
							<div class="single-blog-post">
								<h3>{{ $detailsblog->Name }}</h3>
								<div class="post-meta">
									<ul>
										<li><i class="fa fa-calendar"></i> {{ $detailsblog->Create_at }}</li>
									</ul>
									<span>
								...
								<a href="">
									<img src="{{ URL::to('uploads/' . $detailsblog->Image) }}" alt="">
								</a>
								<p>{{ $detailsblog->Description }}</p>
								<br>
								<p>{{ $detailsblog->Detail }}</p>
								<br>
						...
						@else
							<p>Error: Blog entry not found.</p>
						@endif
					</div><!--/blog-post-area-->
					...
					<div class="rating-area">
						...
						<ul class="tag">
							<li>Danh mục:</li>
							<li><a class="color" href="">Chậu cây cảnh<span>/</span></a></li>
							<li><a class="color" href="">Sen đá <span>/</span></a></li>
							<li><a class="color" href="">Xương rồng</a></li>
						</ul>
					</div><!--/rating-area-->
