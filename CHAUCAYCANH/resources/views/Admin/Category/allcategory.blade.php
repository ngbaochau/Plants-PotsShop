            ...
            @foreach ($allcategory as $cat)
              <tr>
                  ...
                  <td><span class="text-ellipsis">
                    @if ($cat->Status == 0)
                        <a href="{{ URL::to('/unactive_category/'.$cat->CatID) }}">
                            <span class="fa-eye-styling fa fa-eye-slash"></span>
                        </a>
                    @else
                        <a href="{{ URL::to('/active_category/'.$cat->CatID) }}">
                  ...
                  <td>
                      <a href="{{ URL::to('/editcategory/'.$cat->CatID)}}" class="active " ui-toggle-class="">
                          <i class=" fa fa-pencil-square-o" aria-hidden="true" style="size:200px"></i>
                      </a>
                      <a href="{{ URL::to('/deletecategory/'.$cat->CatID)}}" onclick="return confirm('Bạn có muốn xóa danh mục này không?')" class="active" ui-toggle-class="">
